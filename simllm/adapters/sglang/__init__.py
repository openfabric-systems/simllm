...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "SglangDisaggregatedSession": ("pd_session", "SglangDisaggregatedSession"),
    "SglangPdConcurrentResult": ("pd_session", "SglangPdConcurrentResult"),
    "SglangPdCurvePoint": ("pd_session", "SglangPdCurvePoint"),
    "SglangPdCurveRecord": ("pd_session", "SglangPdCurveRecord"),
    "SglangPdRequest": ("pd_session", "SglangPdRequest"),
    "SglangPdRequestResult": ("pd_session", "SglangPdRequestResult"),
    "SglangPdSessionConfig": ("pd_session", "SglangPdSessionConfig"),
