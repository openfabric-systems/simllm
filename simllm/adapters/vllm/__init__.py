...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "ORACLE_SCOPE_ENV": ("oracle", "ORACLE_SCOPE_ENV"),
    ...
    "VllmKvGeometry": ("kv_bridge", "VllmKvGeometry"),
    "VllmKvProjection": ("kv_bridge", "VllmKvProjection"),
    "normalize_vllm_kv_events": ("kv_bridge", "normalize_vllm_kv_events"),
    "read_vllm_kv_sidecar": ("kv_bridge", "read_vllm_kv_sidecar"),
