...
ratio of message bytes to packet bytes that this block fixes is the
amplification factor in \anom{11}, so the incast tax is a downstream
consequence of segmentation and go-back-N and not a separate rule. Finally
...
the retransmission of the rest of the message. The counter semantics of
