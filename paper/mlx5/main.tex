...
\subtitle{ConnectX-5 from public information and black-box measurement to
          FPGA blocks and a golden C reference}
...
\begin{acks}
\TODO{acknowledgements: funding, the cluster operators, and reviewers of the
campaign records. Left empty on purpose for the first draft.}
\end{acks}
