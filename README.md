...
<p align="center">
| <a href="#about"><b>About</b></a> | <a href="#architecture"><b>Architecture</b></a> | <a href="#getting-started"><b>Getting Started</b></a> | <a href="#demo"><b>Demo</b></a> | <a href="#tutorials"><b>Tutorials</b></a> | <a href="#roadmap"><b>Roadmap</b></a> | <a href="#contributing"><b>Contributing</b></a> |
</p>
...
packet-level network underneath, not a `bytes / bandwidth` estimate.
...
- **Workload as a queueing model.** Arrival processes (Poisson, bursty, trace
  ...
  re-prefill traffic, and vRAM pressure are emergent, not assumed.
...
TTFT/TPOT report with bottleneck attribution.
...
- [ ] M1 — standalone core: workload gen → GOAL → htsim → metrics (no frontend)
