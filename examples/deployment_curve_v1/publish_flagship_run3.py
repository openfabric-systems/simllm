#!/usr/bin/env python3
"""Publish the compact repository-sized third CORE-54 scored record."""
...
from flagship_run3_tools import load_json, sha256, write_json

PUBLICATION_SCHEMA = "simllm-deployment-curve-flagship-run3-publication-v1"
...
def build_publication_result(
    ...
    if result.get("schema") != RESULT_SCHEMA:
        raise ValueError("third scored result schema disagrees")
    session_summary = []
    ...
    return {
        ...
        "anchor_access": result["anchor_access"],
        ...
        "second_legend": result["second_legend"],
        ...
        "dominant_held_out_contributor": result["dominant_held_out_contributor"],
...
def main() -> None:
    ...
    inputs = {
        ...
        "anchor_access_ledger": args.access_ledger,
