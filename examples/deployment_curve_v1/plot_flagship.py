"""Render the frozen CORE-54 publication figure from the scored result."""
...
def render_flagship_figure(
    ...
    """Render one publication-sized PDF and PNG from the scored data."""
    ...
    prefill_axis.plot(
        ...
        marker="o",
        linewidth=1.7,
        label="simLLM candidate projection",
    )
    prefill_axis.fill_between(prompt, lower, upper, color=COLORS[0], alpha=0.16)
