...
| Kimi K3 | `moonshotai/Kimi-K3` at exact revision `f831ab66814297da540d832a5235f8e904f29d06`; config and all 96 shard metadata identities are pinned in the [authored suite](../../offline/calibration/suites/kimi-k3-text-v1-frameworks-2026-09-09/suite.json) | Both pinned native configuration seams supply the complete logical text graph. Structural qualification remains COMP-54: the [original study](../../examples/kimi_k3_structure_v1/RESULTS.md) is void because its frozen shared-branch oracle omits final additions. Corrected regression checks are post-specified. Candidate inventories keep physical identities and memory demand unbound; COMP-59 owns hardware coverage. No checkpoint weights or GPU kernels are loaded by this extraction |
