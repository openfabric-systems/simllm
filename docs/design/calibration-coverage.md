...
| Qwen3.8-27B | `Qwen/Qwen3.8-27B` (open Apache 2.0 dense multimodal checkpoint, 27.78B parameters, architecture `Qwen3_5ForConditionalGeneration`); exact revision and hashes pinned at its extraction freeze | Offline text-only denominators published by [model_extraction_qwen38_v2](../../examples/model_extraction_qwen38_v2/RESULTS.md): vLLM [0.27.1](../../offline/calibration/model-inventories/77ea0abb4803d2cab5689f6893563e9a973f0e29160ec1975f1c76b3046e30d1.json) and SGLang [`bfeae4e`](../../offline/calibration/model-inventories/9d1c6164d149b98a4d019bee31d8d3a7ce3ee38cb96b7e0bab03393fde3d4747.json) agree exactly on all 15 cases, the ordered 48 Gated DeltaNet plus 16 full-attention schedule, and 449 logical family visits per case; the [K3 qualification](../../examples/kimi_k3_qualification_v1/RESULTS.md) completes COMP-54 and reproduces both Qwen inventory addresses |
| Qwen3-32B-FP8 | `Qwen/Qwen3-32B-FP8` at exact revision `aa55da1ecc13d006e8b8e4f54579b1ea8c3db2df` | Config-only text denominators published by the [Qwen3-32B suite](../../offline/calibration/suites/qwen3-32b-fp8-text-v1-frameworks-2026-08-28/suite.json): vLLM [0.27.1](../../offline/calibration/model-inventories/c8832ba8ba21e49517b6b74e89554c2abdb0d9e76530f647a7849f3f8448ec56.json) and SGLang [`bfeae4e`](../../offline/calibration/model-inventories/51740b52625002a964e75fddb679e9f8394a08a7d7c62556d2535c3bc60515e3.json) agree exactly on all 15 cases, five logical families and 257 visits per case. Tests verify that both committed objects are canonical at their content-addressed filenames and that their framework-neutral inventories are exact after removing source provenance. The [K3 compatibility extraction](../../examples/kimi_k3_qualification_v1/RESULTS.md) reproduces both accepted addresses in fresh native processes. This comparison-specific column records logical work only and does not claim physical kernel calibration |
| DeepSeek-V3 | `deepseek-ai/DeepSeek-V3` at revision `e815299b0bcbac849fa540c768ef21845365c9eb` (open-weight 671B MoE, 37B active, multi-head latent attention, shared plus routed experts, FP8-native); config, API shard digests and exact source pins are frozen in the suite | Offline text-only denominators published by [model_extraction_deepseek_v3_v1](../../examples/model_extraction_deepseek_v3_v1/RESULTS.md): vLLM [0.27.1](../../offline/calibration/model-inventories/2209f1bdb2055007d935d5e64e79e9cc89d36585415eb220dc90be9f333f53ff.json) and SGLang [`bfeae4e`](../../offline/calibration/model-inventories/5f3f92884fd028532aef0eaa884218a865060780dac92dc02e910beb260967a3.json) agree exactly across 20 cases and 14 families, with 666 ordinary or 667 MTP-enabled logical visits; the [deployment projection](../../offline/calibration/deployment-projections/ee154ed5f07c104269df9cf60d8730b8c6dced0ccf619fb7ff7146ec2ddfd5a2.json) publishes exact EP32, EP72 and EP144 rank classes for the [disclosed units](../papers/deepseek-deployment-disclosures.md), while COMP-69, COMP-70, VLLM-38 and SGL-34 own physical-balancer, realized-MTP and launch-identity residuals |
| Kimi K3 | `moonshotai/Kimi-K3` at exact revision `f831ab66814297da540d832a5235f8e904f29d06`; config and all 96 shard metadata identities are pinned in the [authored suite](../../offline/calibration/suites/kimi-k3-text-v1-frameworks-2026-09-09/suite.json) | The [fresh structural qualification](../../examples/kimi_k3_qualification_v1/RESULTS.md) publishes accepted vLLM [0.27.1](../../offline/calibration/model-inventories/825cb7628cc6635ae77c9d200992189f166c55621ee7ec00d2658d5e21f59bb8.json) and SGLang [`bfeae4e`](../../offline/calibration/model-inventories/7668beca110dc9418636996057be9349fb79e0b481f293347375dd069f809f3a.json) inventories for all 12 cases and closes COMP-54. Both fresh repeats preserve exact bytes. The original study stays void. Logical visits and retained state are qualified; physical identities and memory traffic remain unbound under COMP-59 and COMP-64. No checkpoint weights or GPU kernels are loaded |
