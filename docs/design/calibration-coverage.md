...
| Qwen3-32B-FP8 | `Qwen/Qwen3-32B` at exact revision `aa55da1ecc13d006e8b8e4f54579b1ea8c3db2df`, interpreted through the declared FP8 identity of the frontier comparison | Config-only text denominators published by the [Qwen3-32B suite](../../offline/calibration/suites/qwen3-32b-fp8-text-v1-frameworks-2026-08-28/suite.json): vLLM [0.27.1](../../offline/calibration/model-inventories/c8832ba8ba21e49517b6b74e89554c2abdb0d9e76530f647a7849f3f8448ec56.json) and SGLang [`bfeae4e`](../../offline/calibration/model-inventories/51740b52625002a964e75fddb679e9f8394a08a7d7c62556d2535c3bc60515e3.json) agree exactly on all 15 cases, five logical families and 257 visits per case. Repeated extraction is byte identical, and the framework-neutral inventories are exact after removing source provenance. This comparison-specific column records logical work only and does not claim physical kernel calibration |
