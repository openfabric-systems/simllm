...
|---|---|---|
| [core](modules/core.md) | Implemented: virtual clock, step records, execution contracts, incremental append validation, and the first coarse DeviceRuntime (launch/stream FIFOs, co-runnable kernel dispatch, HBM and copy-engine arbitration, NCCL channels, GPU-affine RNIC submission, identity arbitration, transactional authorities); the structural completion stays conditional on CORE-15 | CORE-3/5/6/8/9/10/11/12/13/14/15, BRIDGE-1 |
