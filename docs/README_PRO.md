...
**51 of 145 registered tasks closed.** 94 remain open across ten modules.
...
| [traffic](modules/traffic.md) | 3 | 12 | `████░░░░░░░░░░░░░░` |
...
| [traffic](modules/traffic.md) | Implemented: collective patterns, TP step mapping, MoE all-to-all with captured non-uniform routing expansion, GOAL renderers for steps and execution graphs | [9 open](modules/traffic.md#open-tasks) |
