...
**62 of 177 registered tasks closed.** 115 remain open across ten modules.
...
| [traffic](modules/traffic.md) | 7 | 22 | `██████░░░░░░░░░░░░` |
...
| [traffic](modules/traffic.md) | Implemented: collective patterns, TP step mapping, MoE all-to-all with captured non-uniform routing expansion, GOAL renderers for steps and execution graphs | [15 open](modules/traffic.md#open-tasks) |
