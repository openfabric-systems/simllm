...
**119 of 319 registered tasks closed.** 200 remain open across 11 modules.
...
| [deploy](modules/deploy.md) | The backend-free planning rung: strict deployment candidates, physical feasibility, stamped capacity estimates, role-pool rate matching, deterministic operating frontiers and promotion through the structural simulation contracts | [3 open](modules/deploy.md#open-tasks) |
