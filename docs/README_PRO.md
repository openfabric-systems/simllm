...
**106 of 290 registered tasks closed.** 184 remain open across ten modules.

`██████████░░░░░░░░░░░░░░░░░░` 37 percent

| Module | Closed | Registered | Progress |
|---|---:|---:|---|
| [core](modules/core.md) | 23 | 46 | `█████████░░░░░░░░░` |
| [workload](modules/workload.md) | 1 | 4 | `████░░░░░░░░░░░░░░` |
| [compute](modules/compute.md) | 9 | 49 | `███░░░░░░░░░░░░░░░` |
| [placement](modules/placement.md) | 2 | 5 | `███████░░░░░░░░░░░` |
| [traffic](modules/traffic.md) | 15 | 56 | `█████░░░░░░░░░░░░░` |
| [goal](modules/goal.md) | 1 | 1 | `██████████████████` |
| [preplay](modules/preplay.md) | 11 | 15 | `█████████████░░░░░` |
| [backends](modules/backends.md) | 30 | 60 | `█████████░░░░░░░░░` |
| [adapters-vllm](modules/adapters-vllm.md) | 8 | 27 | `█████░░░░░░░░░░░░░` |
| [adapters-sglang](modules/adapters-sglang.md) | 6 | 27 | `████░░░░░░░░░░░░░░` |
...
| [traffic](modules/traffic.md) | Semantic collectives to physical flows: TP and MoE patterns with captured expert routing, calibrated collective floors and NVLink forms, GOAL rendering, live framework schedule producers, and the Slingshot-class fabric calibration | [41 open](modules/traffic.md#open-tasks) |
...
| [adapters-vllm](modules/adapters-vllm.md) | The no-fork vLLM adapter: `SimExecutor` on the pinned release, the flagged worker/runner skeleton, simulated communicators and placement export | [19 open](modules/adapters-vllm.md#open-tasks) |
| [adapters-sglang](modules/adapters-sglang.md) | The no-fork SGLang adapter: plugin worker, in-process scheduler loop to TTFT/TPOT, MoE geometry readers, the streaming workload driver and simulated vendored communicators | [21 open](modules/adapters-sglang.md#open-tasks) |
| [adapters-sglang](modules/adapters-sglang.md) | The no-fork SGLang adapter: plugin worker, in-process scheduler loop to TTFT/TPOT, MoE geometry readers, the streaming workload driver and simulated vendored communicators | [21 open](modules/adapters-sglang.md#open-tasks) |
...
| [pd_session_concurrent_v1](../examples/pd_session_concurrent_v1/RESULTS.md) | The VLLM-35 concurrent session and CORE-54 deployment-curve mechanism over one-plus-one, one-plus-two and two-plus-one stock vLLM scheduler pools | REFUTED without a fatal guard: all 18 conservation rows hold at 0 ps maximum TTFT residual, all 144 admissions, handoffs and terminals plus 576 decode tokens conserve exactly, and both roles produce genuine batches in every ratio, but per-token request delay falls or dips in all six post-specified curves rather than following the frozen nondecreasing direction; VLLM-35 stays open and VLLM-39 owns the curve shape |
