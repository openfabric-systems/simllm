...
**128 of 357 registered tasks closed.** 229 remain open across 11 modules.
...
| [deploy](modules/deploy.md) | The backend-free planning rung: strict deployment candidates, physical feasibility, stamped capacity estimates, role-pool rate matching, deterministic operating frontiers and promotion through the structural simulation contracts | [12 open](modules/deploy.md#open-tasks) |
