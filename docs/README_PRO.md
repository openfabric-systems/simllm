...
**127 of 347 registered tasks closed.** 220 remain open across 11 modules.
...
| [traffic](modules/traffic.md) | 22 | 68 | `██████░░░░░░░░░░░░` |
...
| [traffic](modules/traffic.md) | Semantic collectives to physical flows: TP and MoE patterns with captured expert routing, calibrated collective floors and NVLink forms, GOAL rendering, live framework schedule producers, and the Slingshot-class fabric calibration | [46 open](modules/traffic.md#open-tasks) |
