...
**80 of 194 registered tasks closed.** 114 remain open across ten modules.
...
| [traffic](modules/traffic.md) | 12 | 25 | `█████████░░░░░░░░░` |
| [goal](modules/goal.md) | 1 | 1 | `██████████████████` |
| [preplay](modules/preplay.md) | 9 | 14 | `████████████░░░░░░` |
| [backends](modules/backends.md) | 25 | 44 | `██████████░░░░░░░░` |
| [adapters-vllm](modules/adapters-vllm.md) | 6 | 22 | `█████░░░░░░░░░░░░░` |
| [adapters-sglang](modules/adapters-sglang.md) | 2 | 18 | `██░░░░░░░░░░░░░░░░` |
...
| [adapters-sglang](modules/adapters-sglang.md) | Implemented: SimTpModelWorker via plugin entry point at pinned commit, live CPU-engine smoke, exact sample attribution, and the simulated vendored GroupCoordinator on the shared communicator base; the dispatch layer identity comes from SGLang itself, and strict single-GPU Granite/Mixtral/Qwen3 geometry plus a native streaming open-loop workload driver are unit-tested but do not yet reach the simulated metric chain | [16 open](modules/adapters-sglang.md#open-tasks) |
...
| [sglang_moe_workload_v1](../examples/sglang_moe_workload_v1/RESULTS.md) | Strict single-GPU MoE geometry plus deterministic request realization, native streaming payloads, and external client-observed TTFT/TPOT reduction | Void: 10/10 matching rows retained, but 1 of 42 fatal guard instances failed because it contradicted the established `TraceLengths` cycling contract; no simulated request-level or live GPU latency is claimed |
