...
| Design notes | [design/](design/) | Cross-cutting statements that outlive one change: [offline device calibration](design/offline-device-calibration.md), the [packet-device model](design/packet-device-model.md) (devices with typed ports, software stacks as packet producers, port taxonomy, calibration doctrine) and the [HTSIM-9 wrapper package](design/htsim9-atlahs-flow-runtime-wrapper.md) |
...
**98 of 264 registered tasks closed.** 166 remain open across ten modules.

`██████████░░░░░░░░░░░░░░░░░░` 37 percent

| Module | Closed | Registered | Progress |
|---|---:|---:|---|
| [core](modules/core.md) | 23 | 42 | `██████████░░░░░░░░` |
| [workload](modules/workload.md) | 1 | 4 | `████░░░░░░░░░░░░░░` |
| [compute](modules/compute.md) | 6 | 39 | `███░░░░░░░░░░░░░░░` |
...
2. Offline device calibration, in execution waves: freeze and implement the
   vendor-neutral evidence and compact-model contract (COMP-50); capture
   physical graphs and observed bindings (COMP-6, VLLM-12 and SGL-10); qualify
   and run A100, H100 and AMD silicon campaigns (COMP-5, COMP-1, COMP-22 and
   COMP-24); then bind the accepted model to the live batch and provenance path
   (COMP-25 and CORE-45). The optional untouched Accel-Sim sidecar (COMP-51)
...
| [compute](modules/compute.md) | The xPU device, box-composed like the RNIC: typed host and peer ports, deterministic kernel service, concurrent task scheduling, host initiation and the NCCL/RCCL stack behind the real interfaces, plus an offline evidence package that compiles real-device captures and qualified optional simulator observations into a compact device registry; COMP-50 owns the package, COMP-51 the untouched Accel-Sim sidecar and COMP-52 explicit architecture-derived candidates | [33 open](modules/compute.md#open-tasks) |
...
- **M5 (in progress).** All-to-all traffic studies (MoE expert
  ...
  [offline device calibration](design/offline-device-calibration.md). A second
