...
**120 of 327 registered tasks closed.** 207 remain open across 11 modules.
...
| [traffic](modules/traffic.md) | 17 | 64 | `█████░░░░░░░░░░░░░` |
...
| [traffic](modules/traffic.md) | Semantic collectives to physical flows: TP and MoE patterns with captured expert routing, calibrated collective floors and NVLink forms, GOAL rendering, live framework schedule producers, and the Slingshot-class fabric calibration | [47 open](modules/traffic.md#open-tasks) |
