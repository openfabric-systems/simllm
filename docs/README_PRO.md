...
**35 of 137 registered tasks closed.** 102 remain open across ten modules.

`███████░░░░░░░░░░░░░░░░░░░░░` 26 percent

| Module | Closed | Registered | Progress |
|---|---:|---:|---|
| [core](modules/core.md) | 6 | 22 | `█████░░░░░░░░░░░░░` |
| [workload](modules/workload.md) | 0 | 2 | `░░░░░░░░░░░░░░░░░░` |
| [compute](modules/compute.md) | 2 | 18 | `██░░░░░░░░░░░░░░░░` |
| [placement](modules/placement.md) | 0 | 3 | `░░░░░░░░░░░░░░░░░░` |
| [traffic](modules/traffic.md) | 2 | 10 | `████░░░░░░░░░░░░░░` |
| [goal](modules/goal.md) | 1 | 1 | `██████████████████` |
| [preplay](modules/preplay.md) | 4 | 7 | `██████████░░░░░░░░` |
| [backends](modules/backends.md) | 15 | 40 | `███████░░░░░░░░░░░` |
| [adapters-vllm](modules/adapters-vllm.md) | 3 | 19 | `███░░░░░░░░░░░░░░░` |
| [adapters-sglang](modules/adapters-sglang.md) | 2 | 15 | `██░░░░░░░░░░░░░░░░` |
...
4. **Resource queues and data movement.** The first coarse
   ...
   same-contended-graph authority comparison. BACK-9 through BACK-12 complete
   the RNIC mechanisms behind that path, BACK-18 supplies the modular entry
   point, and HTSIM-9 retains packet-issue evidence under BACK-25 and BACK-26.
...
| Proxy progression loop | CPU | send-leg skeleton landed (`ncclProxySaveOp`, `ncclProxyProgress`, `sendProxyProgress`); receive leg open | [COMP-15](modules/compute.md#open-tasks), [BACK-20](modules/backends.md#open-tasks) | [nccl_stack_v1](../examples/nccl_stack_v1/RESULTS.md) |
...
| [adapters-sglang](modules/adapters-sglang.md) | Implemented: SimTpModelWorker via plugin entry point at pinned commit, live CPU-engine smoke, exact sample attribution, and the simulated vendored GroupCoordinator on the shared communicator base | [13 open](modules/adapters-sglang.md#open-tasks) |
...
- **M4 (in progress).** Closed loop validating M2/M3. Landed and
  ...
  closed, CORE-21 retains the same-graph comparison, and HTSIM-9 stays open
  for packet-issue evidence under BACK-25 and BACK-26; the frozen expectations live in
  ...
  lifecycle and the resource runtime (CORE-3 through CORE-5), and
