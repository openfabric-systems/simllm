...
**127 of 346 registered tasks closed.** 219 remain open across 11 modules.
...
| [traffic](modules/traffic.md) | 22 | 66 | `██████░░░░░░░░░░░░` |
...
| [traffic](modules/traffic.md) | Semantic collectives to physical flows: TP and MoE patterns with captured expert routing, calibrated collective floors and NVLink forms, GOAL rendering, live framework schedule producers, and the Slingshot-class fabric calibration | [44 open](modules/traffic.md#open-tasks) |
