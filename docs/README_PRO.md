...
**120 of 324 registered tasks closed.** 204 remain open across 11 modules.

`██████████░░░░░░░░░░░░░░░░░░` 37 percent

| Module | Closed | Registered | Progress |
|---|---:|---:|---|
| [core](modules/core.md) | 28 | 53 | `██████████░░░░░░░░` |
| [deploy](modules/deploy.md) | 1 | 8 | `██░░░░░░░░░░░░░░░░` |
| [workload](modules/workload.md) | 1 | 4 | `████░░░░░░░░░░░░░░` |
| [compute](modules/compute.md) | 11 | 58 | `███░░░░░░░░░░░░░░░` |
| [placement](modules/placement.md) | 2 | 5 | `███████░░░░░░░░░░░` |
| [traffic](modules/traffic.md) | 17 | 61 | `█████░░░░░░░░░░░░░` |
...
|---|---|---|
| [core](modules/core.md) | The runtime spine: virtual clock, execution graphs and validation, transactional device execution, versioned registered-resource completion projection, live device-model provenance, completion reduction into `StepResult` and per-request TTFT/TPOT with critical-path attribution, KV lifecycle accounting before contention, and the structural RNIC network seam | [25 open](modules/core.md#open-tasks) |
| [deploy](modules/deploy.md) | The backend-free planning rung: strict deployment candidates, physical feasibility, stamped capacity estimates, role-pool rate matching, deterministic operating frontiers and promotion through the structural simulation contracts | [7 open](modules/deploy.md#open-tasks) |
...
| [deployment_scan_v1](../examples/deployment_scan_v1/RESULTS.md) | The deployment planning rung's wave gate, frozen before any `simllm/deploy` implementation existed: the installed candidate schema, stamped capacity estimator and deterministic frontier driver reproduce the published CORE-62 analytic and simulated grids from the pinned inputs, satisfy six hand-derived synthetic oracles, recompute bandwidth floors by floor division at 200 and 100 Gbit/s, match the frozen SLA membership sets and the hand-proven Pareto literal, and prove the zero-subprocess property with an armed process interception | PASS, non-void: C1, C2 and C3 reproduce all 18 points each at 0 ps maximum error with exact coordinate fractions, E1 through E6 land on their frozen literals (including the 4,725,000,000 ps overload wait and the 5-to-1 rate match), B1 passes 36 of 36 plus direction, S1 and P1 match their frozen sets exactly, every fatal guard held with zero subprocess interceptions across the whole scan, and the 72-point primary pricing takes 0.031 seconds with the 6,000-point throughput grid at 2.08 seconds on the disclosed machine, both far inside their deliberately generous frozen bands; DEPLOY-1 closes, and the integrator's independent rerun reproduced every scored quantity byte-identically with only wall time and machine provenance differing |
