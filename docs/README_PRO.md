...
**98 of 260 registered tasks closed.** 162 remain open across ten modules.
...
| [compute](modules/compute.md) | 6 | 36 | `███░░░░░░░░░░░░░░░` |
...
| [compute](modules/compute.md) | The xPU device, box-composed like the RNIC: the landed construction entry point with typed PCIe and NVLink ports, deterministic kernel service, concurrent task scheduling, host initiation and the NCCL stack behind the real interfaces; the streaming-crossbar common interface is [COMP-49](modules/compute.md#open-tasks), and port packet emission, measured ceilings and vendor ports are [COMP-40, COMP-41 and COMP-35](modules/compute.md#open-tasks) | [30 open](modules/compute.md#open-tasks) |
