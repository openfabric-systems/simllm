...
remain pending CORE-41's ingress-aware analytic correction. The repository-wide
fidelity selector is `PrecisionConfig`; the cross-check switch is a diagnostic
and names no seam level.
