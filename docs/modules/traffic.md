...
interface and records. [CORE-71](core.md#open-tasks) owns the native timing,
compatibility and failure qualification; physical Clos and buffer-retention
claims require their separately owned paths.
